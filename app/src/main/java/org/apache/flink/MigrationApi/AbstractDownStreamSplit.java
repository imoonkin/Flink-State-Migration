...
public abstract class AbstractDownStreamSplit<IN, OUT, K, V> extends AbstractDownStream<IN, OUT, K, V> {
	public AbstractDownStreamSplit(KeySelector<IN, K> keySelector, KeySelector<IN, V> valueSelector,
